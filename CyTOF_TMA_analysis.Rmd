...
author: "Z.Loncova"
params:
  datadir:  "./imaging/Single_cell_data_markers"
...
png(file.path(params$resultsdir, "cell_densities_per_41_phenotype.png"),  height=600, width=1500)
ggplot(data=melted.counts, aes(x=X1, y=value, fill=value)) +
  ...
  scale_x_discrete(labels=c("01","02","03","04","05","06","07","08","09","10",
                            ...
                            "41")) +
  theme(axis.text.x = element_text(size = 12)) + #10
  theme(axis.text.y = element_text(size = 12)) + #10
  theme(plot.title = element_text(hjust = 0.5, size = 22)) + #14
...
png(file.path(params$resultsdir, "density_pd1_pdl1.png"), height = 800, width = 1200)
