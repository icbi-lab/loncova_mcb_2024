...
dens.pheno.final <-as.data.frame(cbind(rowMeans(dens.pheno[,9:16]),rowMeans(dens.pheno[,40:44]),rowMeans(dens.pheno[,1:8]),   # step 8 i nthe manuscript: sum up the couts for ROIS belonging to the one patient
